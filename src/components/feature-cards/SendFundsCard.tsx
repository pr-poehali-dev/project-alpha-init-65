import { Zap, Hash, ChevronDown, Info } from "lucide-react"
...
export function SendFundsCard() {
  return (
    <div className="rounded-2xl bg-[#141414] border border-[#262626] p-6 flex flex-col">
      ...
      <h3 className="mb-2 text-lg font-semibold text-white">Мгновенные рассылки</h3>
      <p className="mb-4 text-sm text-gray-400">Отправляйте анонсы и сообщения участникам прямо из бота за секунды</p>
      ...
      <div className="mt-auto space-y-4 rounded-xl bg-[#1a1a1a] border border-[#262626] p-4">
        <div className="flex items-center justify-between rounded-lg bg-[#0f0f0f] border border-[#262626] px-3 py-2.5">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-medium text-white">Канал #анонсы</p>
              <p className="text-xs text-gray-500">Подписчиков: 1 248</p>
            </div>
          </div>
        ...
        <div>
          <label className="mb-2 flex items-center gap-1 text-xs text-gray-400">
            Заголовок сообщения <Info className="h-3 w-3" />
          </label>
        ...
        <div>
          <label className="mb-2 flex items-center gap-1 text-xs text-gray-400">
            Текст рассылки <span className="text-violet-400">*</span> (Необязательно)
          </label>
        ...
        <div className="flex items-center justify-between pt-2">
          ...
          <span className="text-sm text-gray-400">Регулярная рассылка</span>
        </div>
      </div>
    </div>
  )
